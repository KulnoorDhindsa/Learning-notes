# OSI-Model
**OSI (Open Systems Interconnection)** is a *layered* architecture, made by **ISO (International Standards Organization)**, allowing communication between various network systems, regardless of their structure
## Layered Structure
- Each layer defines a set of functions different from those performed in other layers.
...
>At layer 1 of sending end system, packet is converted into form that is transferable throught the layers and recieved by recieving end system. The receiving machine unwraps message layer by layer.
